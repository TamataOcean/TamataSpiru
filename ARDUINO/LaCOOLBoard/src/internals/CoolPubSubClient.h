...
#ifndef CoolPubSubClient_h
#define CoolPubSubClient_h
...
public:
   ...
   CoolPubSubClient(IPAddress, uint16_t, Client& client);
   CoolPubSubClient(IPAddress, uint16_t, Client& client, Stream&);
   CoolPubSubClient(IPAddress, uint16_t, MQTT_CALLBACK_SIGNATURE,Client& client);
   CoolPubSubClient(IPAddress, uint16_t, MQTT_CALLBACK_SIGNATURE,Client& client, Stream&);
   CoolPubSubClient(uint8_t *, uint16_t, Client& client);
   CoolPubSubClient(uint8_t *, uint16_t, Client& client, Stream&);
   CoolPubSubClient(uint8_t *, uint16_t, MQTT_CALLBACK_SIGNATURE,Client& client);
   CoolPubSubClient(uint8_t *, uint16_t, MQTT_CALLBACK_SIGNATURE,Client& client, Stream&);
   CoolPubSubClient(const char*, uint16_t, Client& client);
   CoolPubSubClient(const char*, uint16_t, Client& client, Stream&);
